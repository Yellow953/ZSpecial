        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-center">Price: ${{number_format($product->sell_price)}}</p>
                    <p class="text-center my-2">{{$product->description}}</p>
                    <div class="links">

                        <div class="link">
                            <a href="{{$product->instagram_link}}" target="_blank"><svg
                        ...
                        <div class="link">
                            <a href="{{$product->facebook_link}}" target="_blank"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                        ...
                        <div class="link">
                            <a href="{{$product->shopify_link}}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="25" height="25" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
                                    <path
