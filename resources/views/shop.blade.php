                        ...
                        <div class="modal fade" id="exampleModal{{$product->id}}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body py-0 px-3 px-md-5">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 my-auto">
                                                ...
                                                <p class="text-dark text-center font-italic">Check it on Social Media:
                                                </p>
                                                <div class="links">
                                                    <div class="link">
                                                        <a href="{{$product->instagram_link}}" target="_blank">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                                height="25" fill="currentColor" class="bi bi-instagram"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                    ...
                                                    <div class="link">
                                                        <a href="{{$product->facebook_link}}" target="_blank">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                                height="25" fill="currentColor" class="bi bi-facebook"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                ...
                                                <form action="#" method="post" enctype="multipart/form-data"
                                                    ...
                                                    <div class="w-md-100 d-flex justify-content-center">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            class="btn btn-info mx-2 rounded">
